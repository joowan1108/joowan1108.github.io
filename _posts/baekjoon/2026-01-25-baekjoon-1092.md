...
# 보석 찾기 문제 1202번처럼 우선순위 큐를 사용해본 방법

얘는 pop 할 때마다 최적인 애가 안 나오기 때문에 이렇게 풀면 안된다!

**보석찾기 문제랑은 다름**

문제 조건 상 가장 힘쎈 crane부터 가장 무거운 box들을 들어야 하기 때문에 q에는 무거운 box들도 들어감

따라서 q에 있는 애들 중에서 heapq.pop에 의해 나온 가장 무게가 높은 애는 나중에 약한 crane에 의해서 못 뽑힐 수도 있다 -> 이러면 greedy처럼 풀 수 없음
